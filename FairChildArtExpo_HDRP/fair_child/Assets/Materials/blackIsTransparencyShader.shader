...
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 13 math, 3 temp registers
Uses vertex data channel "Vertex"
Uses vertex data channel "Color"
Uses vertex data channel "TexCoord0"
...
//
   ...
   4: add r0.xyzw, r0.xyzw, cb1[3].xyzw
   5: and r1.x, v3.x, l(1)
   6: ishl r1.y, r1.x, l(2)
   7: mov o3.x, r1.x
   8: mul r2.xyzw, r0.yyyy, cb2[r1.y + 25].xyzw
   9: mad r2.xyzw, cb2[r1.y + 24].xyzw, r0.xxxx, r2.xyzw
  10: mad r2.xyzw, cb2[r1.y + 26].xyzw, r0.zzzz, r2.xyzw
  11: mad o0.xyzw, cb2[r1.y + 27].xyzw, r0.wwww, r2.xyzw
  12: mul r0.xyzw, v1.xyzw, cb0[2].xyzw
  13: mul o1.xyzw, r0.xyzw, cb3[0].xyzw
  14: mov o2.xy, v2.xyxx
  15: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Keywords: PIXELSNAP_ON STEREO_INSTANCING_ON
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 19 math, 3 temp registers
Uses vertex data channel "Vertex"
Uses vertex data channel "Color"
Uses vertex data channel "TexCoord0"
...
//
   ...
   6: ishl r1.y, r1.x, l(2)
   7: mov o3.x, r1.x
   8: mul r2.xyzw, r0.yyyy, cb3[r1.y + 25].xyzw
   9: mad r2.xyzw, cb3[r1.y + 24].xyzw, r0.xxxx, r2.xyzw
  10: mad r2.xyzw, cb3[r1.y + 26].xyzw, r0.zzzz, r2.xyzw
  11: mad r0.xyzw, cb3[r1.y + 27].xyzw, r0.wwww, r2.xyzw
  12: div r0.xy, r0.xyxx, r0.wwww
  13: mul r1.xy, cb1[5].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  14: mul r0.xy, r0.xyxx, r1.xyxx
  15: round_ne r0.xy, r0.xyxx
  16: div r0.xy, r0.xyxx, r1.xyxx
  17: mul o0.xy, r0.wwww, r0.xyxx
  18: mov o0.zw, r0.zzzw
  19: mul r0.xyzw, v1.xyzw, cb0[2].xyzw
  20: mul o1.xyzw, r0.xyzw, cb4[0].xyzw
  21: mov o2.xy, v2.xyxx
  22: ret 
// Approximately 0 instruction slots used
...
//////////////////////////////////////////////////////
Keywords: ETC1_EXTERNAL_ALPHA STEREO_INSTANCING_ON
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 13 math, 3 temp registers
Uses vertex data channel "Vertex"
...
//////////////////////////////////////////////////////
Keywords: ETC1_EXTERNAL_ALPHA PIXELSNAP_ON STEREO_INSTANCING_ON
-- Hardware tier variant: Tier 1
-- Vertex shader for "d3d11":
// Stats: 19 math, 3 temp registers
Uses vertex data channel "Vertex"
